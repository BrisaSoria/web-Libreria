...
<nav class="navbar bg-body-tertiary fixed-top">
        ...
        <div class="container-fluid row" style="background-color: rgba(255, 255, 255, .2);backdrop-filter: blur(10px);">
            <form action="" class="col-4 p-3 mx-auto my-5" method="post" enctype="multipart/form-data">
                <h3 class="text-center alert alert-info">Modificar Datos del Producto</h3>
                <input type="hidden" name="id" value="<?=$_GET["id"] ?>">
                <?php
                include "../controlador/editar_producto.php";             
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control" name="imagen" value="<?= $datos->imagen ?>">
                    <img src="<?= $datos->imagen ?>" width=80px height=auto>
                </div>
                <?php }
                ?>
           
            
                <button type="submit" class="btn btn-info" name="btnmodificar" value="ok">Modificar Producto</button>
